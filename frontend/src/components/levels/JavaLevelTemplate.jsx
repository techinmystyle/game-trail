...
const JavaLevelTemplate = ({ challenge, course, phase, levelNumber }) => {
  ...
  const handleCompile = async () => {
    ...
    setIsCompiling(true);
    setConsoleOutput([]);
    addConsoleMessage("🔄 Compiling Java class...", "info");
    ...
    try {
      ...
      const response = await validationAPI.validateJava({
          ...
          >
            ...
            <div className="bg-slate-950/80 px-4 py-2.5 flex items-center justify-between border-b border-slate-900/60 relative">
              ...
              <span className="text-gray-300 text-xs font-mono flex items-center gap-2 font-bold tracking-wide">
                ...
                Solution.java
                <span className="text-[8px] bg-slate-900 text-slate-500 border border-slate-800/80 px-1 rounded-sm uppercase tracking-wider font-mono">Java 17</span>
              </span>
            ...
            <div className="flex-1 bg-[#05050b]/95 p-4 overflow-y-auto font-mono text-xs select-text leading-relaxed custom-scrollbar crt-console">
              ...
              {previewTab === "expected" ? (
                ...
                actualOutput ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center text-slate-555 text-xs text-center font-mono relative z-10">
...
export default JavaLevelTemplate;
