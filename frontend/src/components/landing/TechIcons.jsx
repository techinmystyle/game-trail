...
export const PythonIcon = ({ size = 70 }) => (
  <svg width={size} height={size} viewBox="0 0 256 255" fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      ...
      <linearGradient id="pyG2" x1="0%" y1="100%" x2="0%" y2="0%">
        <stop offset="0%" stopColor="white" stopOpacity="0.95" />
        <stop offset="100%" stopColor="white" stopOpacity="0.85" />
      </linearGradient>
    </defs>
    <path d="M126.916.072c-64.832 0-60.784 28.115-60.784 28.115l.072 29.128h61.868v8.745H41.631S.145 61.355.145 126.77c0 65.417 36.21 63.097 36.21 63.097h21.61v-30.356s-1.165-36.21 35.632-36.21h61.362s34.475.557 34.475-33.319V33.97S194.67.072 126.916.072zM92.802 19.66a11.12 11.12 0 0 1 11.13 11.13 11.12 11.12 0 0 1-11.13 11.13 11.12 11.12 0 0 1-11.13-11.13 11.12 11.12 0 0 1 11.13-11.13z" fill="url(#pyG1)" />
    <path d="M128.757 254.126c64.832 0 60.784-28.115 60.784-28.115l-.072-29.127H127.6v-8.745h86.441s41.486 4.705 41.486-60.712c0-65.416-36.21-63.096-36.21-63.096h-21.61v30.355s1.165 36.21-35.632 36.21h-61.362s-34.475-.557-34.475 33.32v56.013s-5.235 33.897 62.519 33.897zm34.12-19.578a11.12 11.12 0 0 1-11.13-11.13 11.12 11.12 0 0 1 11.13-11.13 11.12 11.12 0 0 1 11.13 11.13 11.12 11.12 0 0 1-11.13 11.13z" fill="url(#pyG2)" />
  </svg>
);
...
export const JavaIcon = ({ size = 70 }) => (
  <svg width={size} height={size} viewBox="0 0 300 420" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M188.462 6.916s38.293 38.293-36.315 97.169c-59.909 47.256-13.658 74.235-.025 105.056-34.979-31.559-60.677-59.339-43.463-85.225C133.974 88.502 204.021 68.605 188.462 6.916" fill="white" fillOpacity="0.85" />
    <path d="M116.814 374.379c66.402 4.25 168.371-2.363 170.717-33.799 0 0-4.641 11.906-54.849 21.363-56.684 10.717-126.552 9.461-168.059 2.598 0-.001 8.502 7.028 52.191 9.838" fill="white" fillOpacity="0.9" />
  </svg>
);
