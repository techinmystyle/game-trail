      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          <div style={{
            ...
            fontFamily: 'monospace', fontSize: 9, color: CM_ACCENT, letterSpacing: 2,
          }}>
            ⚔️ HUMAN VS HUMAN
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            {profileImage
              ...
              : <div style={{ width: 32, height: 32, borderRadius: '50%', background: `${CM_ACCENT}25`, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Rajdhani, sans-serif', fontWeight: 900, fontSize: 12, color: CM_ACCENT }}>{username[0]}</div>
            }
            <div>
              <div style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 800, fontSize: 12, color: 'white' }}>{username}</div>
              <div style={{ fontFamily: 'monospace', fontSize: 8, color: isHost ? CM_ACCENT : 'rgba(255,255,255,0.3)' }}>
                {isHost ? '👑 HOST' : 'PLAYER'}
              </div>
            </div>
          </div>
                  ...
                  {msg.isSystem ? (
                    ...
                    <>
                      ...
                      <div style={{
                        ...
                        fontFamily: 'monospace', fontSize: 12, color: 'white', maxWidth: '85%', lineHeight: 1.5,
                      }}>{msg.text}</div>
                    </>
                  )}
                </div>
              ...
              <div style={{ display: 'flex', gap: 8 }}>
                <input
                  ...
                  style={{
                    ...
                    fontFamily: 'monospace', fontSize: 12, outline: 'none', caretColor: CM_ACCENT,
                  }}
                />
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 14, minWidth: 0, overflowY: 'auto' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: totalPlayers === 4 ? 'repeat(2,1fr)' : `repeat(${totalPlayers},1fr)`, gap: 12 }}>
                  ...
                  <div key={player.userId || idx} style={{
                    ...
                    <div style={{ position: 'relative' }}>
                      {isMe && profileImage
                        ...
                        : <div style={{ width: 48, height: 48, borderRadius: '50%', background: player.ready ? `${CM_ACCENT}25` : 'rgba(255,255,255,0.06)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Rajdhani, sans-serif', fontWeight: 900, fontSize: 18, color: player.ready ? CM_ACCENT : 'rgba(255,255,255,0.3)' }}>
                    ...
                    <div>
                      ...
                      <div style={{ fontFamily: 'monospace', fontSize: 9, color: player.ready ? '#10b981' : 'rgba(255,255,255,0.3)', marginTop: 2 }}>
              ...
              {Array.from({ length: Math.max(0, totalPlayers - activePlayers.length) }).map((_, i) => (
                <div key={`empty-${i}`} style={{
                  ...
                  <div style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 700, fontSize: 12, color: 'rgba(255,255,255,0.2)' }}>
                    Waiting for player...
                  </div>
                  <div style={{ fontFamily: 'monospace', fontSize: 9, color: 'rgba(255,255,255,0.1)' }}>SLOT OPEN</div>
                </div>
              ))}
            </div>
          </div>
            ...
            <div style={cardStyle}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 12 }}>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: 'monospace', fontSize: 9, color: 'rgba(255,255,255,0.25)' }}>Up to 5 spectator slots — optional</div>
                </div>
                <button onClick={handleSpectateToggle} style={{
                  ...
                  color: isSpectator ? CM_ACCENT : 'rgba(255,255,255,0.5)',
          ...
          {activePlayers.length < totalPlayers && (
            <div style={{
              ...
              <span style={{ fontFamily: 'monospace', fontSize: 11, color: CM_ORANGE }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: 12, cursor: 'pointer', flex: 1 }}>
                ...
                <span style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 800, fontSize: 15,
                  color: accepted ? CM_ACCENT : 'rgba(255,255,255,0.5)', textTransform: 'uppercase', letterSpacing: 1 }}>
