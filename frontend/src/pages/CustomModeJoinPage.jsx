        ...
        <div style={{ width: '100%', maxWidth: 480 }}>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              {/* Room ID */}
              <div>
                <label style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 800, fontSize: 11, textTransform: 'uppercase', letterSpacing: 2, color: CM_ACCENT, display: 'block', marginBottom: 8 }}>
              ...
              <div>
                <label style={{ fontFamily: 'Rajdhani, sans-serif', fontWeight: 800, fontSize: 11, textTransform: 'uppercase', letterSpacing: 2, color: 'rgba(255,255,255,0.5)', display: 'block', marginBottom: 8 }}>
                  PASSWORD <span style={{ color: 'rgba(255,255,255,0.25)', textTransform: 'lowercase', fontSize: 10 }}>(required)</span>
                </label>
                <div style={{ position: 'relative' }}>
