...
/* ─── Binary Rain (same style as ComputerModePage) ──────────────── */
...
const CourseCard = ({ course, theme, onClick }) => {
  ...
  /* When hovered, use the language's own brand color for the card glow */
  const cardGlow = hovered ? langColor : theme.accent;
  ...
  return (
    ...
    >
      {/* Top glowing scan line on hover */}
      {hovered && (
        <div style={{
      ...
      <div style={{ padding: "0 26px 26px", flex: 1, display: "flex", flexDirection: "column" }}>
        ...
        <button
          style={{
            ...
            color: hovered ? "#fff" : "white", cursor: "pointer",
            fontFamily: "Rajdhani, sans-serif", fontWeight: 900,
...
const LevelsModePage = () => {
  ...
  return (
    <div style={{ minHeight: "100vh", background: pageBg, color: "white", position: "relative", overflow: "hidden", transition: "background 0.4s ease" }}>
      ...
      {/* ── Binary Rain Background (same as Computer Mode) ── */}
      ...
      <div style={{
        ...
        background: `radial-gradient(circle, ${ac}16 0%, transparent 65%)`,
      ...
      <div style={{
        ...
        pointerEvents: "none", zIndex: 0, animation: "floatA 12s ease-in-out infinite reverse",
        transition: "background 0.4s",
      }} />
      <div style={{
        position: "fixed", bottom: "5%", left: "5%",
        width: 380, height: 380,
        background: `radial-gradient(circle, ${ac}08 0%, transparent 65%)`,
        pointerEvents: "none", zIndex: 0, animation: "floatA 14s ease-in-out infinite 2s",
        transition: "background 0.4s",
      }} />
